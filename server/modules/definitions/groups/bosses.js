...
Class.FNB = {
   PARENT: 'genericTank',
   LABEL: 'Final Nest Boss',
   SHAPE: 5,
   DANGER: 100,
   SIZE: 50,
   COLOR: 14,
   GUNS: [ {
         POSITION: [ 12, 8, 1, 0, 0, -37.5, 0, ],
         PROPERTIES: {
         ...
         POSITION: [ 11, 2, 2, 0, 0, 0, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "hypermissile",
         }, }, {
         POSITION: [ 11, 2, 2, 0, 0, -71, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "hypermissile",
         }, }, {
         POSITION: [ 11, 2, 2, 0, 0, -142.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "hypermissile",
         }, }, {
         ...
         POSITION: [ 11, 2, 2, 0, 0, 71.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "hypermissile",
         }, }, {
         POSITION: [ 11, 2, 3, 0, 0, 105, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "pillbox",
         }, }, {
         POSITION: [ 11, 2, 3, 0, 0, 37.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.Nspeed, g.bigger, g.pounder, g.destroyer]),
            TYPE: "pillbox",
         }, }, {
...
Class.minifort = {
    ...
    SKILL: skillSet({ rld: 9, dam: 9, pen: 9, str: 9, spd: 1, atk: 9, hlt: 9, shi: 9, rgn: 9, mob: 1 }),
    SHAPE: [[-1,0],[-0.6,0.4],[-0.5,0.3],[-0.3,0.5],[-0.4,0.6],[0,1],[0.4,0.6],[0.3,0.5],[0.5,0.3],[0.6,0.4],[1,0],[0.6,-0.4],[0.5,-0.3],[0.3,-0.5],[0.4,-0.6],[0,-1],[-0.4,-0.6],[-0.3,-0.5],[-0.5,-0.3],[-0.6,-0.4]],
    GUNS: [
        {
            POSITION: [ 7, 2.25, 1, 0, 0, 135, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.pounder,g.machineGun]),
            TYPE: "bullet"
         }, }, {
         POSITION: [ 7, 2.25, 1, 0, 0, -135, 0, ],
         PROPERTIES: {
    ...
    TURRETS: [
        ...
        POSITION: [4, 6.5, 0, 90, 360, 1],
        TYPE: "bigauto4gun"
    }, {
        POSITION: [5, 0, 0, 45, 360, 1],
        TYPE: "periodicFireTurretnotw"
    }, {
        POSITION: [4, 6.5, 0, 180, 360, 1],
        TYPE: "bigauto4gun"
    }, {
        POSITION: [4, 6.5, 0, 270, 360, 1],
        TYPE: "bigauto4gun"
        },
    ],
};
...
Class.SuperCrasherAttackingForm = {
    PARENT: ["eternal2"],
    UPGRADE_COLOR: "pink",
    FACING_TYPE: "toTarget",
    SHAPE: 3,
    MAX_CHILDREN: 1,
    LABEL: "Super Crasher - Attacking Form",
ON: [
        {
            event: "fire",
            handler: ({ body, gun }) => {
                if (gun.identifier != 'onHandler') return //MAKE SPECIAL GUN!*
                setTimeout(() => {
                    body.define('SuperCrasherShieldForm') //the form what will become after the time
                    body.sendMessage('No-no-no i wanna sleep, please lemme sleep')//custom self-message :D
                }, 45000)// time after what u will define
                setTimeout(() => body.sendMessage('Super Crasher becoming Another Form!'), 40000)//server custom message, will activated by timer too, but some earlier
            }
        }
    ],
    GUNS: [
...
Class.SuperCrasherShieldForm = {
    PARENT: ["eternal2"],
    UPGRADE_COLOR: "pink",
    FACING_TYPE: "toTarget",
    MAX_CHILDREN: 0,
    LABEL: "Super Crasher - Shield Form",
ON: [
        {
            event: "fire",
            handler: ({ body, gun }) => {
                if (gun.identifier != 'onHandler') return //MAKE SPECIAL GUN!*
                setTimeout(() => {
                    body.define('SuperCrasherBulletHellForm') //the form what will become after the time
                    body.sendMessage('Ok am ready TO GO!')//custom self-message :D
                }, 45000)// time after what u will define
                setTimeout(() => body.sendMessage('Super Crasher becoming Another Form!'), 40000)//server custom message, will activated by timer too, but some earlier
            }
        }
    ...
    GUNS: [
        {
            POSITION: [4, 16, 1.5, 14, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.hexaTrapper, g.machineGun, g.morereload, g.morereload]),
                TYPE: "bullet",
            },
        },{
    ...
    ON: [
        {
            ...
            handler: ({ body, gun }) => {
                if (gun.identifier != 'onHandler') return //MAKE SPECIAL GUN!*
                setTimeout(() => {
                    body.define('SuperCrasherAttackingForm') //the form what will become after the time
                    body.sendMessage('Ok guys, i spawned so die i guess..?')//custom self-message :D
                }, 0)// time after what u will define
                setTimeout(() => body.sendMessage('Super Crasher has been dropped at warlands!'), 0)//server custom message, will activated by timer too, but some earlier
            }
        }
    ],
    GUNS: [
        {
            POSITION: [4, 16, 1.5, 0, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.hexaTrapper, g.machineGun, g.morereload, g.morereload]),
                TYPE: "bullet",
            },
        },{
            POSITION: [4, 16, 1.5, 0, 0, 60, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.hexaTrapper, g.machineGun, g.morereload, g.morereload]),
                TYPE: "bullet",
            },
...
Class.SuperCrasherBulletHellForm = {
    PARENT: ["eternal2"],
    UPGRADE_COLOR: "pink",
    FACING_TYPE: "toTarget",
    LABEL: "Super Crasher - Bullet Hell Form",
    MAX_CHILDREN: 0,
    ON: [
        {
            event: "fire",
            handler: ({ body, gun }) => {
                if (gun.identifier != 'onHandler') return //MAKE SPECIAL GUN!*
                setTimeout(() => {
                    body.define('SuperCrasherLandmineForm') //the form what will become after the time
                    body.sendMessage('Ok guys, try to dodge THIS!')//custom self-message :D
                }, 45000)// time after what u will define
                setTimeout(() => body.sendMessage('Super Crasher becoming Another Form!'), 40000)//server custom message, will activated by timer too, but some earlier
            }
        }
    ...
    GUNS: [
        {
            POSITION: [4, 16, 1.5, 6, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.morereload, g.morereload,g.morereload, g.pounder, g.destroyer, g.annihilator]),
                TYPE: "bullet",
            },
        },{
            POSITION: [4, 16, 1.5, 6, 0, 60, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.morereload, g.morereload,g.morereload, g.pounder, g.destroyer, g.annihilator]),
                TYPE: "bullet",
            },
...
Class.SuperCrasherLandmineForm = {
    PARENT: ["eternal2"],
    UPGRADE_COLOR: "pink",
    FACING_TYPE: "toTarget",
    MAX_CHILDREN: 0,
    LABEL: "Super Crasher - Landmine Form",
    ON: [
        {
            event: "fire",
            handler: ({ body, gun }) => {
                ...
                setTimeout(() => {
                    body.define('SuperCrasherAttackingForm') //the form what will become after the time
                    body.sendMessage('Ok guys i will attack u again now')//custom self-message :D
                }, 45000)// time after what u will define
                setTimeout(() => body.sendMessage('Super Crasher becoming Another Form!'), 40000)//server custom message, will activated by timer too, but some earlier
            }
        }
    ...
    GUNS: [
        {
            ...
            POSITION: [4, 16, 1.5, 14, 0, 60, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.morereload, g.morereload]),
                TYPE: "unsetPillbox",
                STAT_CALCULATOR: gunCalcNames.trap,
            },
        },
...
GUNS: [
{
POSITION: [44.308,8,1,0,0,90,0],
PROPERTIES: {
}, },
{
POSITION: [44.308,8,1,0,0,270,0],
PROPERTIES: {
}, },
{
POSITION: [19.385,8,1,-9.692,-18,0,0],
PROPERTIES: {
...
{
POSITION: [19.385,8,1,-9.692,30.462,0,0.5],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([[40, 0, 0.001, 1, 1, 0.75, 1, 6.3, 1, 3, 1, 0.00001, 1]]),
TYPE: "dogeiscutMissile_red",
}, },
...
{
POSITION: [19.385,8,1,-9.692,-42.369,0,1],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([[40, 0, 0.001, 1, 1, 0.75, 1, 6.3, 1, 3, 1, 0.00001, 1]]),
TYPE: "dogeiscutMissile_red",
}, },
...
{
POSITION: [6.923,10.24,1,6.923,42.369,180,1],
PROPERTIES: {
}, },
{
POSITION: [6.923,10.24,1,6.923,-42.369,180,1],
...
{
POSITION: [6.923,10.24,1,6.923,-30.462,180,1],
PROPERTIES: {
}, },
{
POSITION: [6.923,10.24,1,6.923,30.462,180,1],
...
{
POSITION: [6.923,10.24,1,6.923,18,180,1],
PROPERTIES: {
}, },
{
POSITION: [6.923,10.24,1,6.923,-18,180,1],
...
Class.homingRocket = {
    ...
    LABEL: "Missile",
    INDEPENDENT: true,
    BODY: { RANGE: 350, DAMAGE: 6, SPEED: 5 },
    SHAPE: 0,
    TURRETS: [{
        POSITION: {
            ANGLE: 180,
...
Class.fasterRocket = {
    ...
    GUNS: [
        {
          POSITION: [ 23, 9, 1.5, 0, 0, 180, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.missileTrail]),
            TYPE: "bullet"
             }, }, {
            POSITION: [16.5, 10, 1.5, 0, 0, 180, 4],
            PROPERTIES: {
...
Class.lrcm = {
   ...
   LABEL: 'Long-Range Carpet Missiler',
   UPGRADE_LABEL: 'L.R.C.M',
   BODY: {
     FOV: 2
   },
   SIZE: 20,
   GUNS: [ {
         POSITION: [ 42, 6, 1, 0, 0, 112.5, 0, ],
         }, {
         POSITION: [ 42, 6, 1, 0, 0, -112.5, 0, ],
         }, {
         POSITION: [ 25, 6, 1, -13, 17, 22.5, 0.4, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 25, 6, 1, -13, -17, -22.5, 0.6, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 25, 6, 1, -13, 27, 22.5, 1.3, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 25, 6, 1, -13, -27, -22.5, 1.6, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 25, 6, 1, -13, 37, 22.5, 2.2, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 25, 6, 1, -13, -37, -22.5, 2.7, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: Class.homingRocket,
         }, }, {
         POSITION: [ 11, 7, 1, -6, 46, 22.5, 0, ],
         }, {
         POSITION: [ 11, 7, 1, -6, -46, -22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, 37, 22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, -37, -22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, 17, 22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, -17, -22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, 27, 22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, -27, -22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, 27, 22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, -27, -22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, 17, 22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, -17, -22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, 37, 22.5, 0, ],
         }, {
         POSITION: [ 20.3, 0, 1, -8.5, -37, -22.5, 0, ],
         }, {
         POSITION: [ 6, 8, 1, -15, 37, 22.5, 0, ],
         ...
         POSITION: [ 87, 7, 1, -34, 0, 0, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.launcher, g.rocketeer,g.power]),
            TYPE: "fasterRocket",
         }, }, {
         POSITION: [ 10, 15, 1, -38, 0, 0, 0, ],
         }, {
         POSITION: [ 6, 10, 1, -41, 0, 0, 0, ],
         }, {
         POSITION: [ 10, 15, 1, -38, 0, 0, 0, ],
         }, {
         POSITION: [ 80.5, 3, 1, -27.3, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 15, 1, -30, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 15, 1, -38, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, -34, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, -34, 4.8, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, -34, -4.8, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 46, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 37, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 28, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 19, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 19, 0, 180, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 10, 0, 0, 0, ],
         }, {
         POSITION: [ 2, 2, 1, 10, 0, -180, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -33, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -33, 4.8, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -33, -4.8, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -20, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -11, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -11, 0, 180, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 20, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 29, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 38, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 47, 0, 0, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -47, 90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -38, 90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -29, 90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -20, 90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -11, 90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -11, -90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -20, -90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 0, -33, -90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, 4.8, -33, -90, 0, ],
         }, {
         POSITION: [ 0, 2, 1, -4.8, -33, -90, 0, ],
         }, 
     ],
