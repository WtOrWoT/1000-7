...
// Spammers
    pewpewpew___pewpewpew: { reload: 22, recoil: 0.5, shudder: 0.05, damage: 0.35, speed: 5.0, spray: 5 },
...
// Heavy cannons
    ...
    megoingtourmom: { reload: 0.1, recoil: 0, health: 78546138686534876234897436775 },
...
// Misc
    ...
    bigger: { size: 2 },
    Nspeed: { speed: 0.002, maxSpeed: 0, recoil: 0 },
    less_speed_Nrecoil: { reload: 1, recoil: 0, shudder: 1, size: 1, health: 1, damage: 1, pen: 1, speed: 0.7, maxSpeed: 1, range: 1, density: 1, spray: 1, resist: 1 },
    less_damage: { reload: 1, recoil: 0.3, shudder: 0.2, size: 1, health: 1, damage: 0.5, pen: 1, speed: 1.5, maxSpeed: 2, range: 1, density: 1, spray: 2.5, resist: 1 },
    ...
    thrust_more_reload: { recoil: 1.5, shudder: 2, health: 0.3, damage: 0.3, pen: 0.7, spray: 0.5, resist: 0.7, reload: 0.3},
    thrust_lower_reload: { recoil: 3, shudder: 2, health: 0.3, damage: 1, pen: 0.7, spray: 0.5, resist: 0.7, reload: 5},
    ultraspread: { spray: 360 },
    speedo1: {
    reload: 1.3,
    recoil: 1.5,
    shudder: 0.001,
